...
def _ensure_unique_composite_keys(
    ...
    مثال::
        ...
        Traceback (most recent call last):
            ...
        DatabaseOperationError: جدول mentor_pool_cache دارای ردیف تکراری برای کلید ترکیبی است؛ نمونه‌ها: [{'mentor_id': 'm1', 'کدرشته': 1, 'جنسیت': 1, 'دانش آموز فارغ': 0, 'مرکز گلستان صدرا': 1, 'مالی حکمت بنیاد': 0, 'کد مدرسه': 3581}]
    """
