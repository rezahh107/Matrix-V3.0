...
CANON_EN_TO_FA: Mapping[str, str] = {
    ...
    "student_landline": "تلفن منزل",
    "student_registration_status": "وضعیت ثبت نام",
    "student_educational_status": "وضعیت تحصیلی",
    "contact1_relationship": "نسبت رابط 1",
    "contact2_relationship": "نسبت رابط 2",
    "manager_name": "نام مدیر",
    "exam_groups_included": "شامل گروه های آزمایشی",
}
...
HEADER_ALIASES_V3: Mapping[str, Mapping[str, str]] = {
    ...
    "student": {
        ...
        "finance": "مالی حکمت بنیاد",
        "مالی حکمت بنیاد": "مالی حکمت بنیاد",
        "عادی حکمت بنیاد (0 یا 3 یا 1)": "مالی حکمت بنیاد",
        "کد مدرسه": "کد مدرسه",
        "school code": "کد مدرسه",
        "student_registration_status": "student_registration_status",
        "وضعیت ثبت نام": "student_registration_status",
        "عادی حکمت بنیاد": "student_registration_status",
        "student_educational_status": "student_educational_status",
        "وضعیت تحصیلی": "student_educational_status",
        "دانش آموز - فارغ التحصیل": "student_educational_status",
        "student_landline": "student_landline",
        "تلفن منزل": "student_landline",
        "تلفن ثابت": "student_landline",
        ...
        "نسبت رابط 1": "contact1_relationship",
        "contact2_relationship": "contact2_relationship",
        "نسبت رابط 2": "contact2_relationship",
        "hekmat_tracking": "hekmat_tracking",
        "کد رهگیری حکمت": "hekmat_tracking",
        ...
        "نام": "student_first_name",
        "نام خانوادگی": "student_last_name",
        "نام خانوادگي": "student_last_name",
        "نام‌خانوادگی": "student_last_name",
        "تاریخ تولد": "تاریخ تولد",
        "دانش آموز - فارغ التحصیل (1 یا 0)": "دانش آموز - فارغ التحصیل (1 یا 0)",
        "تلفن منزل (اگر وضعیت ثبت نام 3 بود و این سلول خالی بود به جای آن 00000000000 گذاشته شود": "تلفن منزل (اگر وضعیت ثبت نام 3 بود و این سلول خالی بود به جای آن 00000000000 گذاشته شود",
        "تلفن همراه داوطلب": "تلفن همراه داوطلب",
        "شماره پرونده بنیاد شهید (اگر وضعیت ثبت نام 1 باشد)": "شماره پرونده بنیاد شهید (اگر وضعیت ثبت نام 1 باشد)",
        "شماره پرونده بنیاد شهید": "شماره پرونده بنیاد شهید",
        "تخفیف": "تخفیف",
        "تلفن همراه پدر": "تلفن همراه پدر",
        "تلفن همراه مادر": "تلفن همراه مادر",
        "کد رهگیری حکمت (اگر وضعیت ثبت نام 3 باشد مقدار این سلول میشه 1111111111111111)": "کد رهگیری حکمت (اگر وضعیت ثبت نام 3 باشد مقدار این سلول میشه 1111111111111111)",
        "4001": "4001",
        "معدل": "معدل",
    },
    "school": {
    ...
    "groupcode": {
        ...
        "گروه‌آزمایشی": "experimental_group",
        "گروه آزمایشی (اختیاری)": "experimental_group",
