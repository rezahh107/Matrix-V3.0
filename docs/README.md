...
- در Eligibility Matrix، ستون‌های «نام مدرسه 1..4» بر اساس مقدار معتبر (>0) و به ترتیب ستون‌ها مصرف می‌شوند؛
  اگر «تعداد مدارس تحت پوشش» مشخص باشد فقط همان تعداد اول استفاده می‌شود و کمبود آن خطای QA است.
