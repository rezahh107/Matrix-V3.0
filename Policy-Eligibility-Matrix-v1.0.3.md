...
3. **کد رشته (Field Code):** شناسهٔ عددی یکتا برای هر گروه/پایه.

### 4.2) جدول مرجع کامل (۳۲ ردیف)
...
### 4.4) قواعد نگاشت و وضعیت دوگانه
...
- سطح/گروه/کد باید همواره سه‌گانهٔ معتبر از جدول ۴.۲ باشند؛ Crosswalk هر مقدار دیگری را **خطا** یا «unseen» ثبت می‌کند.

### 4.5) مثال‌های استفاده صحیح/نادرست
