...
#### 4.2.2) تعاریف وضعیت تحصیلی (Academic Status Definitions)
- **{0,1}:** «دانش آموز یا فارغ التحصیل» (Dual-Status)
- **{1}:** «فقط دانش آموز» (Student-Only)

#### 4.2.3) گروه‌های دوحالته (Dual-Status Groups — 11)
- **کنکوری (۶ گروه):** کدهای 1، 3، 5، 7، 8، 9
- **هنرستان دوازدهم (۵ گروه):** کدهای 11، 12، 14، 17، 18
- **وضعیت مجاز:** {0,1}

#### 4.2.4) گروه‌های فقط دانش‌آموز (Student-Only Groups — 22)
- **متوسطه دوم:** ۸ گروه
- **متوسطه اول:** ۳ گروه
- **دبستان:** ۵ گروه
- **هنرستان (دهم و یازدهم):** ۶ گروه
- **وضعیت مجاز:** {1}
...
| کنکوری | هنر | 7 | {0,1} (کد ۷ ≠ پایه هفتم) |
...
| متوسطه اول | هفتم | 33 | {1} (کد ۳۳ = پایه هفتم واقعی) |
| دبستان | دوم دبستان | 46 | {1} |
| دبستان | سوم دبستان | 45 | {1} |
| دبستان | چهارم دبستان | 43 | {1} |
| دبستان | پنجم دبستان | 41 | {1} (کد ۴۱ = پایه پنجم واقعی) |
